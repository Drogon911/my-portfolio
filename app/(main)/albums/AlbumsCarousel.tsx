...
// Карусели нужны только метаданные релиза (+ предрендеренная размытая обложка),
// поэтому server-страница передаёт урезанную форму без списка треков.
...
export default function AlbumsCarousel({ albums }: { albums: CarouselAlbum[] }) {
