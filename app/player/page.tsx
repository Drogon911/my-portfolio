  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="absolute top-4 left-4 z-50">
        <Link
          href="/"
          className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-md rounded-full text-white text-sm font-medium hover:bg-purple-500/40 hover:text-white transition-all duration-300 border border-white/30 shadow-lg"
        >
          ← На главную
        </Link>
      </div>
      ...
      <div className="relative z-10 flex-1 flex flex-col">
        ...
        <div className="w-full bg-white/20 backdrop-blur-lg border-t border-white/30 shadow-2xl rounded-t-3xl p-6 pb-8">
          ...
          <div className="flex gap-8 justify-center items-center mt-6">
            <button
              onClick={prevTrack}
              className="p-3 rounded-full bg-white/30 hover:bg-white/50 transition text-white text-2xl"
            >
              ⏮
            </button>
            <button
              onClick={togglePlay}
              className="p-5 rounded-full bg-white hover:bg-pink-50 transition shadow-lg text-pink-600 text-3xl"
            >
              {isPlaying ? "⏸" : "▶"}
            </button>
            <button
